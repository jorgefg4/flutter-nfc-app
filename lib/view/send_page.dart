...
//inicializo el manejador
  ...
  void writeUrl() async {
    ...
    if(nfcAvailable == false) {
      setState(() {
        resultado = "NFC descativado. Por favor, actívalo e inicia de nuevo el envío.";
  ...
  void writeEvent() async {
    ...
    nfcHandler.writeEvent(_titleToWrite!, _locationToWrite!, _selectedInitialDate, _selectedEndDate);
  } // writeEvent()
                ...
                children: <Widget>[
                  ...
                  Column(
                    ...
                    children: <Widget>[
                      ...
                      //formulario URL
                      Visibility(
                        visible: selectedButton2 && !selectedButton3 && !selectedButton4 && !selectedButton5,
                        child:
                        Container(
                          width: 300.0,
                          decoration: BoxDecoration(
