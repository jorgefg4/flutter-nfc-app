...
class _MyHomePageState extends State<MyHomePage> {
  ...
  // Para requerir permisos al iniciar app
  ...
  void initState() {
    super.initState();
    helpMessage =
        'Puede leer contenido de otro teléfono pulsando el botón de iniciar lectura y acercando su teléfono a otro a una distancia de pocos centímetros. Asegúrese de que NFC está activado en su terminal. ';
              ...
              switch (index) {
                ...
                case 1:
                  setState(() {
                    currentPageIndex = index;
                    helpMessage =
                        'Seleccione uno de los formatos de información disponibles para enviar hacia otro teléfono. También puede utilizar la función de compartir URL desde cualquier aplicación externa.';
                  });
                ...
                case 2:
                  setState(() {
                    currentPageIndex = index;
                    helpMessage =
                        'Esta página muestra el historial de los últimos 10 elementos leídos. Pulse sobre cualquiera de ellos para visualizar o guardar.';
                  });
